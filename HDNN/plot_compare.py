...
LOAD_PATHS = ["TwoLayersPaper/vanilla_5it","TwoLayersIDS/vanilla_5it","J1/ReLU/vanilla_1it","J1/Tanh/vanilla_1it","J2/vanilla_1it"]
...
for i, col_name in enumerate(COL_NAMES):
    ...
    sns.lineplot(data = df, x="network", y=COL_NAMES[i], color=u'#1f77b4', label = "Test")
    sns.lineplot(data = df, x="network", y=COL_NAMES[i+1], color=u'#1f77b4', linestyle="--", label="Train")
    plt.xticks(NAMES)
    plt.legend()
    plt.show()
